...
pokemon = csv_string.splitlines()
# print(pokemon[4])

csv_file = np.genfromtxt('C:/Users/Yadnesh/Downloads/pokemre.csv', delimiter=",")

hps = csv_file[:,2]
attacks = csv_file[:,3]
defenses = csv_file[:,4]
sp_attacks = csv_file[:,5]
sp_defenses = csv_file[:,6]
speeds = csv_file[:,7]
generations = csv_file[:,8]


dict = {}
for i in range(1,800):
    arr = [hps[i], attacks[i], defenses[i], sp_attacks[i], sp_defenses[i], speeds[i]]
    dict[pokemon[i]] = arr
